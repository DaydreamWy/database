...
{
    public partial class ProductPutIO : Form
    {
        private string p_id; 
        private PaneProduct father;
        private int func_id;
        //func_id——1：入库 2：出库
        public ProductPutIO(PaneProduct father,string pid,int func_id)
        {
            this.p_id = pid;
            this.father = father;
            ...
            textBox1.Text = Login.LoginUserId;
            textBox2.Text = p_id;
            if (func_id == 1)
            {
                label1.Text = "入库";
            ...
            {
                MessageBox.Show("new ProductPutIO() wrong!");
                this.Close();
            }
        ...
        {
            string s_id = Login.LoginUserId;//= textBox1.Text;  //获取输入的商家编号
