...
namespace databaseproject
{
    public partial class OrderConfirm : Form
    {
        ...
        public OrderConfirm(string p_id, string p_name)
        {
            this.para_p_id = p_id;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string sql2 = string.Format(
                    ...
                    , this.para_p_id, Login.LoginUserId, buy_number, buy_time, buy_money,buy_address,buy_phone);//buy_p_id
                SqlFunc.ExecuteSql(sql2);

                MessageBox.Show("订单已经生成，即将跳转支付页面");
                //支付界面
                PayMoney childrenForm = new PayMoney();
